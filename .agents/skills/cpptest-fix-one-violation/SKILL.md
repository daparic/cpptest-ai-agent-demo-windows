...
| --- | --- | --- | --- |
| Script | `cpptest-analyze.ps1` | Builds the project and runs Parasoft C/C++test analysis. This is **the only way** to run the analysis; using other commands or tools may lead to incorrect results. | Report error and exit |
...
```powershell
powershell -ExecutionPolicy Bypass -File ./cpptest-analyze.ps1
```
